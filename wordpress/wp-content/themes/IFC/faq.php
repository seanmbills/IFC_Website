            ...
            <div class="col-lg-12">
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseOne">What are IFC's statistics on Georgia Tech's campus?</a>
                            </h2>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseTwo">What does IFC do?</a>
                            </h2>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseThree">What is the purpose of IFC?</a>
                            </h2>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="caption">
                                            <p>
                                                ...
                                                <ul>
                                                    <li>Further excellence in scholarship </li>
                                                    <li>Act in conjunction with member fraternities and University to boast and uphold high social and moral standards</li>
                                                    <li>Provide programs and services to member fraternities</li>
                                                    <li>Act as a liaison between member fraternities and other student organizations, the student body, the faculty, and the administration of Georgia Tech
                                                Encourage the growth of a positive relationship between the community and member fraternities</li>
                                                    <li>Implement policies and rules that will further the mission of Greek Life at Georgia Tech.</li>
                                                </ul>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseFour">Who are we?</a>
                            </h2>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseFive">What do we do?</a>
                            </h2>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseSix">How can I participate in IFC?</a>
                            </h2>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="caption">
                                            <p>
                                                ...
                                                <h5><strong>Committee Chairs:</strong></h5>
                                                ...
                                                <h5><strong>Executive Board Positions:</strong></h5>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseSeven">How do I join a Fraternity?</a>
                            </h2>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseEight">What is rush all about?</a>
                            </h2>
                        </div>
...
As a student at Georgia Tech there are a plethora of opportunities that one can get involved in that can enrich your college experience. As you are looking for your niche at Tech, we encourage you to explore the IFC fraternity system. Fraternity men are some of the most well rounded individuals on campus- they are student leaders, athletes, and scholars. There is a place for every man within Tech's Greek System. There are 32 Fraternity Chapters, each unique, and we highly recommend that you take the time to explore them all. Fraternity Rush is a free, non-binding and extremely memorable experience. It gives you the opportunity to meet many new people, including fellow rushees and fraternity men, while enjoying social events and awesome food. We are honored that you are considering the IFC Fraternity system and hope that you will make the most of your time here. Please enjoy all of the resources available to you here, we look forward to meeting you at IFC rush!
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseNine">How does rush work?</a>
                            </h2>
                        </div>
...
If the chapter chooses you as someone they would like to have as a part of their organization, they will offer you an official "bid" to join. In the case that this happens, it is up to you to determine whether or not you wish to accept this bid. You can receive bids from any number of houses, in which case you will have to decide which chapter you would most like to join. While you will also have the option of not accepting a bid anywhere, it is highly recommended that you join a chapter should the opportunity present itself.                                            </p>
                                        </div>
                                    </div>
                                </div> <!-- closes out the "row" div -->
                            </div> <!-- closes out panel body -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title" style="text-align:center;">
                                <a class="accordion-toggle" data-toggle="collapse" href="#collapseTen">Why should I participate in Fraternity life at Georgia Tech?</a>
                            </h2>
                        </div>
