                        ...
                        <div class="modal-content">
                            ...
                            <div class="chapter-information-outer">
                                <div class="col-md-12 text-center">
                                    ...
                                    <div class="col-md-7" style="text-align:left; margin-bottom:10px;">
                                        <p>
                                            Phi Kappa Psi (Phi Psi) is a diverse brotherhood of honorable gentlemen who strive for scholastic, athletic and social excellence. Phi Kappa Psi is the largest national foundation of any Fraternity and we boast hundreds of successful alumni ranging from former president Woodrow Wilson to the famous TV actor Zach Braff. As a fraternity on Tech’s campus, we aim to further academic excellence by encouraging and requiring academic sessions and study hours from all our brothers. This has proven to be helpful, as a good amount of our brothers have continued to excel academically. In addition to academic excellence, Phi Psi aims to establish and build campus relations by consistently participating in intramurals; from volleyball and 3v3 basketball, we value competition as well as building teamwork and friendships. While we do view intramurals as being very important, our school involvement is not limited to only sports. Our public motto is “The Great Joy of Serving Others”, so each semester we fundraise for Alex’s Lemonade Stand. Additionally, we encourage all brothers to volunteer at charities in their community. Above all being a Phi Psi is about forming strong bonds of friendship that will last a lifetime.
                                        </p>
                                    </div>
                                    <div class="col-md-5" style="position:relative;height:100%;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="chapter-information-outer">
                                <div class="col-md-12 text-center" style="margin-bottom:25px;">
                                    ...
                                    <div class="col-md-7" style="text-align:left; margin-bottom:10px;">
                                        <p>
                                            One of the oldest chapters on Georgia Tech's campus, the Georgia Phi Chapter of Sigma Alpha Epsilon was founded in 1890 and still continues to hold itself to the highest of standards. We believe that being truly successful in college, not to mention after graduation, requires a balance between academics, leadership, athletics, and gentlemanly conduct. Our chapter prides itself on being strong in all four areas.

                                            We guide ourselves by two principles: one is The True Gentleman, our creed which states how a gentleman should conduct himself towards others. This can be seen through our strong Philanthropy and Service through organizations such as Atlanta Mission's Homeless Shelters, Trees Atlanta, Habitat for Humanity, and Children's Miracle Network. The other is the principle that once you are an SAE, you are an SAE for life. This is clearly shown by our huge alumni presence, involvement with the Atlanta Area Alumni Association, and ties to famous Georgia Phi alumni such as the golfer Bobby Jones and former mayor of Atlanta Ivan Allen, Jr. Many of our brothers make valuable business contacts among the several thousand alumni active in the area that often lead to internships and career leads.

                                            In addition, we continue to maintain one of the strongest social calendars and closest brotherhoods on campus. This is evidenced by yearly trips to destinations such as New Orleans, Gulf Shores, and Beech Mountain and social events featuring artists such as DRAM, JID, Two Friends, and the Zac Brown Band among others.
                                        </p>
                                    </div>
                                    <div class="col-md-5" style="position:relative;height:100%;">
